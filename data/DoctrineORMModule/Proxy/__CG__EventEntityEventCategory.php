 ...
 */
class EventCategory extends \Event\Entity\EventCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'description', '' . "\0" . 'Event\\Entity\\EventCategory' . "\0" . 'file', '' . "\0" . 'Event\\Entity\\EventCategory' . "\0" . 'events', 'dateCreated', 'createdBy', 'dateChanged', 'changedBy', 'dateDeleted', 'deletedBy', 'deleted'];
        }
    ...
    public function removeEvents($events)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeEvents', [$events]);

        return parent::removeEvents($events);
    }
